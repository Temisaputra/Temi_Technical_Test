...
A clean-architecture Go project for managing vouchers and other modules with GORM, PostgreSQL, and Swagger API documentation.
...
```bash
mockgen -source=internal/repository/voucher_repository.go -destination=./shared/mock/repository/repository_mock.go -package repository
```
